...
class FlowAutocompleteAdapter {
  async getSuggestions(connection, request) {
    ...
    return FlowAutocompleteAdapter.completionItemsToSuggestions(
      completionItems,
      request
    );
  }
  ...
  static completionItemsToSuggestions(completionItems, request) {
    return (Array.isArray(completionItems)
      ? completionItems
      : completionItems.items || []).map(s =>
...
FlowAutocompleteAdapter.completionKindToSuggestionType =
  AutocompleteAdapter.completionKindToSuggestionType;
FlowAutocompleteAdapter.requestToTextDocumentPositionParams =
  AutocompleteAdapter.requestToTextDocumentPositionParams;
FlowAutocompleteAdapter.applyTextEditToSuggestion =
  AutocompleteAdapter.applyTextEditToSuggestion;
